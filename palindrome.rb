...
# end
# This is good to avoid to allow for extremely large strings as the above method would double the memory requirement 
...
# and iterating espcially for extremely large strings and thereby decrease computaitonal time.
#
...
class String
	...
	# * *Raises*  :
	#	- This method contains no additional error checking methods
	def is_palindrome?
